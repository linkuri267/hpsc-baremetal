...
#define MBOX_LSIO__RTPS_R52_0_TRCH 0
#define MBOX_LSIO__TRCH_RTPS_R52_0 1

#define MBOX_LSIO__RTPS_R52_1_TRCH 2
#define MBOX_LSIO__TRCH_RTPS_R52_1 3

#define MBOX_LSIO__RTPS_A53_TRCH_PSCI 4
#define MBOX_LSIO__TRCH_RTPS_A53_PSCI 5
...
#define MBOX_LSIO__RTPS_RCV_INT_PSCI 4
#define MBOX_LSIO__RTPS_ACK_INT_PSCI 5
