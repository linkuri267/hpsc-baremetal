...
#define HPPS_DDR_LOW_SIZE   0x1fc00000 // excludes TRCH reservations in HPPS DRAM

// Boot config (TODO: to be replaced by u-boot env/script)
#define HPPS_BOOT_MODE_ADDR 0xc001fffc

// Shared memory regions accessible to HPPS
#define HPPS_SHM_ADDR 0xc3400000
#define HPPS_SHM_SIZE   0x400000

// Shared memory regions for userspace
#define HPPS_SHM_ADDR__TRCH_HPPS 0xc3600000
#define HPPS_SHM_SIZE__TRCH_HPPS 0x10000
#define HPPS_SHM_ADDR__HPPS_TRCH 0xc3610000
#define HPPS_SHM_SIZE__HPPS_TRCH 0x10000

// Shared memory regions for SSW
#define HPPS_SHM_ADDR__TRCH_HPPS_SSW 0xc39f0000
#define HPPS_SHM_SIZE__TRCH_HPPS_SSW 0x08000
#define HPPS_SHM_ADDR__HPPS_TRCH_SSW 0xc39f8000
